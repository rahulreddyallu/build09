# signal_validator.py - COMPLETE PRODUCTION VERSION WITH FULL HISTORICAL INTEGRATION
# ==================================================================================
# Signal Validation with Complete 6-Stage Pipeline
# Stages 1-4: Technical Validation (existing)
# Stages 5-6: Historical Accuracy Validation & Confidence Calibration (NEW)
# Author: rahulreddyallu
# Version: 4.5 (Production - Fully Integrated with Historical Database)
# Date: 2025-11-30

"""
SIGNAL VALIDATOR - COMPLETE 6-STAGE VALIDATION ENGINE WITH HISTORICAL INTEGRATION
===================================================================================
...
✓ Stage 5: Historical Accuracy Validation - Query historical pattern accuracy (NEW)
✓ Stage 6: Confidence Calibration - Adjust confidence based on historical data (NEW)

Total: 7-10 points possible (10 = PREMIUM, 8-9 = HIGH, 6-7 = MEDIUM, 4-5 = LOW, <4 = REJECT)
...
# Import configuration and historical database
try:
    from config import (
        BotConfiguration,
        SignalTier,
...
# NEW: Import historical validation system
try:
...
class SignalValidator:
    ...
    logging, and historical integration.
    """
    ...
    def __init__(
        ...
        """
        Initialize validator with optional historical database integration.
        ...
        # Default parameters if config not provided
        if config:
        ...
        try:
            ...
            if self.accuracy_db:
                historical_validation = self._run_historical_validation(
                    pattern_name, market_regime, signal_direction,
                    result.pattern_score + result.indicator_score + result.context_score + result.risk_score
                )

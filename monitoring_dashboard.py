...
class MonitoringDashboard:
    ...
    def _print_current_signals(self, stocks_data: List[Dict[str, Any]]) -> None:
        ...
        for stock in stocks_data:
            ...
            for pattern in patterns:
                ...
                print(f"│ {emoji} {symbol:8} | {direction:4} | {pattern.pattern_name:20} | "
    ...
    def _print_performance_stats(self) -> None:
        ...
        print(f"│ Signals Generated: {metrics.signals_generated:3} | "
        ...
        print(f"│ Avg RRR Promised: {metrics.avg_rrr_promised:5.2f}:1 | "
              f"Achieved: {metrics.avg_rrr_achieved:5.2f}:1 | "
              f"Total P&L: {metrics.total_pnl_pct:+6.2f}% │")
        print(f"│                                                                              │")
        print(f"│ Best Pattern: {metrics.best_pattern:15} ({metrics.best_pattern_winrate*100:5.1f}%) | "
    ...
    def _print_open_positions(self) -> None:
        ...
        if not open_signals:
            ...
            for signal in open_signals[-5:]:  # Show last 5 open
                ...
                print(f"│ {emoji} {signal.symbol:8} | {signal.direction:4} | "
...
class DashboardInterface:
    ...
    def _handle_manual_validation(self) -> None:
        ...
        # Note: In real usage, would fetch actual data from Upstox API
    ...
    def _display_signal_history(self) -> None:
        ...
        for signal in signals[-10:]:  # Show last 10
            ...
            print(f"{emoji} {signal.symbol:8} {signal.direction:4} {signal.pattern:20} "
    ...
    def _display_metrics(self, metrics: PerformanceMetrics) -> None:
        ...
        print("─" * 70)
        print(f"Generated: {metrics.signals_generated:3} | "
              f"Sent: {metrics.signals_sent:3} | "
              f"Open: {metrics.signals_open:3} | "
              f"Closed: {metrics.signals_closed:3}")
        print(f"Win Rate: {metrics.win_rate*100:5.1f}% | "
